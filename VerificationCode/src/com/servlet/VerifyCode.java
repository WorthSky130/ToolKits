...
public class VerifyCode {
	...
	// 使用方法
	public void demo(javax.servlet.http.HttpServletRequest req, javax.servlet.http.HttpServletResponse response,
			javax.servlet.http.HttpSession session) throws IOException {
